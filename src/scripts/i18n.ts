...
const messages = {
  es: {
    ...
    'detail.reviewsLabel': 'Enlaces a críticas externas',
    'detail.reviewsKicker': 'Crítica y recepción',
    'detail.searchAt': 'Buscar en',
    'detail.reviewsNote': 'La búsqueda se abre en el sitio externo para que puedas elegir la edición correcta.',
  ...
  en: {
    ...
    'detail.reviewsLabel': 'External review links',
    'detail.reviewsKicker': 'Reviews and reception',
    'detail.searchAt': 'Search on',
    'detail.reviewsNote': 'The search opens on the external site so you can choose the correct edition.',
